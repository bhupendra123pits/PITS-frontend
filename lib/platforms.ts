...
export const platforms: Record<string, Platform> = {
  shopify: {
    ...
    services: [
      ...
      { title: "Order processing & fulfillment", body: "Order routing, fulfillment coordination, tracking updates, and exception handling — every order tracked end to end." },
  ...
  woocommerce: {
    ...
    whatWeHandle: [
      ...
      },
      {
        ...
        bullets: [
          "Customer support — email and chat, in your brand voice, within agreed SLAs",
          "Order management and fulfillment tracking via WooCommerce dashboard",
